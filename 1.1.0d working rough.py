...
class GrammarApp:
    ...
    def submit_matches(self):
        ...
        if self.current_word_index != first_index:
            # Merge meanings from all previous occurrences (from first_index up to but not including current occurrence)
            merged_meanings = []
            ...
            # Compare the current selection with prior selections
            current_selected = selected_meanings  # current selection for this occurrence
