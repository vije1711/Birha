...
# Dynamically load the main module file with a non-importable name
...
extract = birha_mod.extract_darpan_meaning_from_translation


class TestExtractDarpanMeaning(unittest.TestCase):
